...
/// @section Program constants and definitions
#define FS_TRIFECTA_PORT 8888
#define FS_TRIFECTA_DEVICE_IDENTIFY_PORT 6868
...
#define FS_MAX_DEVICE_PATH_LENGTH 256
#define FS_MAX_IP_ADDRESS_LENGTH 64
